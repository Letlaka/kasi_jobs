...
if TYPE_CHECKING:
    ...
    from utilities.db.mandb_actions import StdoutProtocol, StyleProtocol

from utilities.db.mandb_actions import perform_action
...
class Command(BaseCommand):
    help = (
        ...
        "  create  → make the DB;\n"
        "  drop    → terminate + drop the DB;\n"
        "  reset   → delete all migrations + drop the DB;\n"
    ...
    def add_arguments(self, parser: ArgumentParser) -> None:
        ...
        parser.add_argument(
            "--include-owner",
            action="store_true",
            help="Include original object owners and privileges in dump/restore.",
        )
        parser.add_argument(
            "--backup",
